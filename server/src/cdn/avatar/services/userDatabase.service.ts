...
export async function getAvatarIdByUserId(db: PostgresClient<Contract>, userId: string): Promise<string|null> {
  // TODO: replace mockup onto the real database operation
  return "6240";
}

export async function setAvatarIdForUser(db: PostgresClient<Contract>, userId: string, avatarId: string|null, newAvatarId: string|null): Promise<boolean> {
